...
function _aws_cdk_aws_logs_QueryDefinitionProps(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.logGroups))
            _aws_cdk_aws_logs_ILogGroup(p.logGroups);
    }
    finally {
        visitedObjects.delete(p);
    }
